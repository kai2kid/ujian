...
var MonthYearColor="#996666";//Font Color of Month and Year in Calendar header.
var WeekHeadColor="#cc9966";//Background Color in Week header.
...
var FontColor="#ffffcc";//color of font in Calendar day cell.
var TodayColor="#ffcc66";//Background color of today.
var SelDateColor="#ffff66";//Backgrond color of selected date in textbox.
...
var CalBgColor="#ffcc99";//Backgroud color of Calendar window.
...
var WeekDayName1=["Minggu","Senin","Selasa","Rabu","Kamis","Jum'at","Sabtu"];
//var WeekDayName2=["Monday","Tuesday","Wednesday","Thursday","Friday","Saturday","Sunday"];
var WeekDayName2=["Senin","Selasa","Rabu","Kamis","Jum'at","Sabtu","Minggu"];
...
function dateTimePicker(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds) {
...
function RenderCssCal(bNewCal) {
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if (winCal == undefined) {
	   ...
	   with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = (ypos-8)+'px'; width = CalWidth; border = "solid 2pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 1000;}
